...
export const config = {
  ...
  matcher: ["/((?!zalo_verifier|login|api/auth|api/cron|api/zalo/webhook|news/view|register|patient-register|api/followers/register|api/followers/patient-register|_next/static|_next/image|favicon.ico).*)"],
};
