...
export const config = {
  ...
  matcher: ["/((?!zalo_verifier|login|api/auth|api/cron|api/zalo/webhook|api/webhook|api/miniapp|api/articles|api/payload-articles|news/view|register|patient-register|api/followers/register|api/followers/patient-register|api/followers/restore-staff|api/check-old-db|_next/static|_next/image|favicon.ico|manifest.json|sw.js|cdc-logo.png|uploads).*)"],
};
